...
//    /** Contrôle nommage */    //QSqlQuery query("SELECT \"DELETED\", \"NOEUD\", \"TRANCHE\", \"NOEUD_BIS\" from noeuds order by \"TRANCHE\"");
...
//    query.prepare("select  hexa, adr, bal, phd, parcelle, zoneavant, habitat, chau_type as \"type de chaussee\", chau_anc as \"anciennete\", tro_type as \"type de trottoir\", tro_anc as \"anciennete\", 'communal' as \"gestionnaire de voie\", nro, poche, pm, adduction, concessionnaire, reference as numpm, logements as lrpm, comment"
//                    "from (select *"
//                    "from ( select *"
